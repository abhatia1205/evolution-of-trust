...
class Minion(Player):
    ...
    def act(self) -> Action:
        ...
        if(len(self.other_history) == 0): #Cooperates first time
            return Action.CHEAT
        elif(self.other_history(len(self.other_history) - 2) == Action.COOPERATE and self.other_history[-1] == Action.COOPERATE):
            return Action.COOPERATE
        return Action.CHEAT
        #return self.other_history[-2] #Copies other player
